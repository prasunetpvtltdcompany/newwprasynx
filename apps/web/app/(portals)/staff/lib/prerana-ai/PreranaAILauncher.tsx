      ...
      <div className="relative flex flex-col items-center">
        ...
        <AnimatePresence>
          {hasNotifs && (
            ...
            >
              <div className="relative w-[10px] h-[10px] rounded-full bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.5)]">
                <motion.div
              ...
              {badgeCount > 1 && (
                <div className="absolute -top-2.5 right-2 min-w-4 w-4 h-4 px-1 rounded-full bg-red-500 border-[1.5px] border-white flex items-center justify-center text-[8px] font-bold text-white shadow-md shadow-red-500/30">
                  {badgeCount}
                </div>
              )}
            </motion.div>
